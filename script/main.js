...
var modal = {
  ...
  "数学部・物理部": {
    heading: "数学部・物理部",
    text: "103教室には以下の2つの部活の展示を行なっています！",
    onClicks: [
  ...
  "美術部・漫画研究会": {
    heading: "美術部・漫画研究会",
    // imgSrc: "",
    text: `202教室には以下の2つの部活の展示を行なっています！`,
    onClicks: [
  ...
  "HeartBeat": {
    ...
    testOther: "301・302　2-1・207　お化け屋敷",
  ...
  "謎解きはランチの前で": {
    ...
    testOther: "401・402　2-2・2-5　脱出ゲーム",
