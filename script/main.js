...
var modal = {
  ...
  "文スタ展示_校内祭": {
    ...
    textOther: "403教室　文化祭スタッフ",
    text: `校内・一般共通の展示は長田高校の未知の領域の特集！！長田生でも知らない教室や空間の謎を解き明かします！加えて、校内祭ではアンケート企画入賞者へのインタビューもお届けします！
